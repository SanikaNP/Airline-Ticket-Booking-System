...
Label(fr2,text="Welcome to Airline Ticket Booking System",font=("algerian",38),compound="center",fg="Orange").pack()
...
def airline():
    ...
    b=PhotoImage(file="aeroplane.gif")
    Label(root1,image=b).grid(row=0,column=0,columnspan=4)
    Label(root1,text="Flights Availability",font=("Times New Roman",17),fg="White",width=46,bg="red").grid(row=1,column=0,columnspan=4)
    ...
    def signup():
                 ...
                 Label(root,text="Welcome to Airline Booking Systems",font=("Times New Roman",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                 ...
                 def signin():
                     ...
                     Label(root2,text="Welcome to Airplane Booking System",font=("Times New Roman",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                     ...
                     def bookingportal():
                          ...
                          if a==[]:
                                ...
                                Label(root4,text="Welcome to Airplane Booking System",font=("Times New Roman",17),fg="Red",width=46,bg="White").grid(row=0,column=0,columnspan=4)
                                Label(root4,text="Booking Portal",font=("Times New Roman",17),fg="White",width=46,bg="red").grid(row=1,column=0,columnspan=4)
                                Label(root4,text="Enter Your Details",font=("Times New Roman",14),fg="Blue",width=46).grid(row=2,column=0,columnspan=4)
                                Label(root4,text="Full Name",font=("Times New Roman",14),fg="blue").grid(row=3,column=1)
                                name=Entry()
                                name.grid(row=3,column=2)
                                Label(root4,text="Enter Your age",font=("Times New Roman",14),fg="Blue").grid(row=4,column=1)
                                age=Entry(width=4)
                                age.grid(row=4,column=2)
                                Label(root4,text="Select Gender",font=("Times New Roman",14),fg="blue").grid(row=5,column=1)
                                a=IntVar()
                                ...
                                Label(root4,text="Seat Class",font=("Times New Roman",14),fg="blue").grid(row=6,column=1)
                                v= StringVar(root4)
                                v.set("Select class") # default value
                                w = OptionMenu(root4, v, "First Class", "Business Class", "Economy Class")
                                w.grid(row=6,column=2)
                                Label(root4,text="Additional Passengers Details",font=("Times New Roman",14),fg="Blue",width=46).grid(row=7,column=0,columnspan=4)
                                ...
                                Label(root4,text="Seat Class",font=("Times New Roman",14),fg="blue").grid(row=10,column=1)
                                v1= StringVar(root4)
                                v1.set("Select class") # default value
                                w1 = OptionMenu(root4, v1, "First Class", "Business Class", "Economy Class")
                                w1.grid(row=10,column=2)
                                Label(root4,text="Passenger 2",font=("Times New Roman",14),fg="Blue").grid(row=11,column=1)
                                name2=Entry()
                                name2.grid(row=11,column=2)
                                Label(root4,text="Enter age",font=("Times New Roman",14),fg="Blue").grid(row=12,column=1)
                                age2=Entry(width=4)
                                age2.grid(row=12,column=2)
                                Label(root4,text="Seat Class",font=("Times New Roman",14),fg="blue").grid(row=13,column=1)
                                v2= StringVar(root4)
                                ...
                                Label(root4,text="Seat Class",font=("Times New Roman",14),fg="blue").grid(row=16,column=1)
                                v3= StringVar(root4)
                                v3.set("Select class") # default value
                                w3 = OptionMenu(root4, v3, "First Class", "Business Class", "Economy Class")
                                w3.grid(row=16,column=2)
                                Label(root4, text="Journey Date:",font=("Times New Roman",14),fg="blue").grid(row=17,column=1)
                                date = Entry(root4, width=15, font=("Times New Roman", 14),fg="Blue")
                                date.grid(row=17, column=2)
                                date.insert(0,"DD/MM/YYYY")
                                Label(root4,text="Number of Passengers",font=("Times New Roman",14),fg="blue").grid(row=18,column=1)
                                v4= StringVar(root4)
                                ...
                                def data():
                                        ...
                                        Label(root5,text="Thanks For Choosing Airplane Booking System",font=("Times New Roman",17),fg="White",bg="red",width=46).grid(row=0,column=0,columnspan=4)
                                        Label(root5,text="Ticket Details",font=("Times New Roman",17),fg="Blue",width=46).grid(row=1,column=0,columnspan=4)
    ...
    root1.mainloop()
Button(fr2,text="PROCEED",compound="center",bg="Yellow",font=("algerian"),fg="blue",command=airline).pack()
root.mainloop()
